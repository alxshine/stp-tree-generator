...
Chapter~\ref{background} will cover the background knowledge needed to fully understand the tool we developed.
In chapter~\ref{stp-gen} we will discuss the implementation and problems we faced during the development of our tool.
Chapter~\ref{switch} shows the details of our \textit{software-switch} tool, which we used for testing.
Chapter~\ref{testing} explains how and to what extent we tested our tool, as well as the results.
