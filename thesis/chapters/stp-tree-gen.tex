...
When the client witnesses the message age increasing, it assumes that the new root should be prepended to the previous one.
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \begin{tikzpicture}
            ...
            \begin{customlegend}[legend cell align=left, legend entries={Correct Ass., Incorrect Ass., Connection}, legend style={at={(8.2,8.5)},font=\footnotesize}]
                \addlegendimage{draw=green}
                \addlegendimage{draw=red}
                \addlegendimage{draw=black}
            \end{customlegend}
