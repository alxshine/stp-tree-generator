...
Default parameters are overwritten by any parameters found in the config file.
...
The interfaces to bridge are passed via the command line as well.
%TODO: same as for stp-tree-gen
