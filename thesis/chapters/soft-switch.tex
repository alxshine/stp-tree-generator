...
Sharing memory between \textit{pthreads} (the C thread implementation we used) does not require any setup, as all heap memory is shared. %TODO: source?
...
%TODO: keep helloTime and forwardDelay spelling consistent
