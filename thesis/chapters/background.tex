...
The parameters discussed default to the following values:
\begin{itemize}
    ...
    \item \textbf{Hello Time}: 2
        %TODO:cite http://www.brocade.com/content/html/en/configuration-guide/FI_08030_L2/GUID-256DE2C6-C2DC-4DE0-A0C2-A96DDF0C3406.html
\end{itemize}
