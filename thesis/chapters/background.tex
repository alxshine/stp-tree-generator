...
This means that if there is a bridge between these two, we will not know about it's id.
We will however still know that it is there, because of the message age.
During the buildup of the tree it is possible to obtain information on immediate nodes.
